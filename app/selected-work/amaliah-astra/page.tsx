...
export default function AmaliahAstraPage() {
  ...
  "
            >
              <p>
                ...
                to maximize the social and environmental value of the
            ...
            >
              <div className="animate-grid-item">
                ...
                <p className="mt-2 leading-relaxed">
                  ...
                  and community care was clearly communicated.
                </p>
              </div>
